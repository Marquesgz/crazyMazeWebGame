...
document.addEventListener('keydown', (event) => {
    ...
    const movements = { 37: 'Left', 38: 'Up1', 39: 'Right', 40: 'Down' };
...
function solve(cells, start, end) {
    ...
    const polar = solution.map((cell, i) => ({ ...cell.polarCoordinates, o: cell.outsideMore, s: cell.after(solution[i + 1]) ? 0 : 1 }));
